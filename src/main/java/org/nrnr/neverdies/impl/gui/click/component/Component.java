...
public abstract class Component implements Drawable, Globals {
    ...
    protected void rectGradientComponent(DrawContext context, int color1, int color2) {
        fillGradient(context, x, y + 0.5, x + width, y + height - 0.5, color1, color2);
    }
    ...
    public void drawBorder(DrawContext context, float x, float y, float width,
