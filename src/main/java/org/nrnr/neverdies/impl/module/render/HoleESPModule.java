...
public class HoleESPModule extends ToggleModule {
    //
    Config<Float> rangeConfig = new NumberConfig<>("Range", "Range to display holes", 3.0f, 10.0f, 25.0f);
    ...
    public void onRenderWorld(RenderWorldEvent event) {
        ...
        for (Hole hole : Managers.HOLE.getHoles()) {
            ...
            RenderManagerWorld.renderBox(event.getMatrices(), render, getHoleColor(hole.getSafety(), alpha));
            RenderManagerWorld.renderBoundingBox(event.getMatrices(), render, 1.5f, getHoleColor(hole.getSafety(), (int) (alpha * 145.0f)));
        }
    }
