...
public class ColorsModule extends ConcurrentModule {
    //
    Config<Color> colorConfig = new ColorConfig("Color", "The primary client color", new Color(171, 139, 252), false, false);
    Config<Color> outlineColorConfig = new ColorConfig("Outline Color", "The outline color", new Color(171, 139, 252), false, false);
