    ...
    public void onRenderWorld(RenderWorldEvent event) {
        ...
        for (BlockPos blockPos : posList) {
            ...
            if (closestPlayer != null && renderConfig.getValue() == Render.OUTLINE) {
                RenderManagerWorld.renderBoundingBox(event.getMatrices(), blockPos, lineWidth.getValue(), colorConfig.getValue().getRGB());
            }
            else if (closestPlayer != null && renderConfig.getValue() == Render.BOX){
                RenderManagerWorld.renderBox(event.getMatrices(), blockPos, colorConfig.getValue().getRGB());
            }
